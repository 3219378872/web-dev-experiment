...
sync_note: "fix(#103): OrderFormDTO 新增 couponId 字段；OrderServiceImpl.createOrder 服务端重新计算运费(对齐 Controller)、校验优惠券有效性；CouponServiceImpl 新增 useCoupon；OrderServiceImplTest 适配新构造函数 + 4 个新测试覆盖运费/优惠券"
---
