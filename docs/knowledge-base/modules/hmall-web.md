...
sync_note: "fix(#91): Category.vue 分类分页；fix(#93): ItemDetail.vue 动态 spec；fix(#94): 移除 dtabs sticky；fix(#99): Home/FlashSale/OrderList 硬编码数据修复；fix(#103): OrderConfirm/OrderDetail API集成；fix(#105-#111): feature pages修复、backend images字段支持；codex-review findings全部修复"
---
