...
sync_note: "Issue #130/#133: login 支持用户名/邮箱/手机号三标识；新增 GET /users/profile 返回 UserVO；User/UserVO 增 gender/birthday 并在 updateProfile 持久化（迁移 docs/sql/user-service-profile-fields.sql）"
---
