...
sync_note: "Issue #86: 多个 @FeignClient 指向同一服务时新增 contextId；Issue #100: OrderClient 和 UserClient 添加 fallbackFactory 降级实现；fix(#103): OrderFormDTO 新增 freight/couponId 字段"
---
