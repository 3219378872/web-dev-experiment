<template>
  <div class="home">
    ...
    <div v-if="newItems.length" class="section">
      <h2 class="section-title">新品推荐</h2>
      <el-row :gutter="16">
        <el-col v-for="item in newItems" :key="item.id" :xs="12" :sm="8" :md="6">
          <ProductCard :item="item" />
        </el-col>
      </el-row>
    </div>
...
.banner .el-carousel__item:nth-child(1) .banner-placeholder {
  background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
}
.banner .el-carousel__item:nth-child(2) .banner-placeholder {
  background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);
}
.banner .el-carousel__item:nth-child(3) .banner-placeholder {
