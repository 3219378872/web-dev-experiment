...
export const useCartStore = defineStore('cart', {
  ...
  actions: {
    ...
    async addItem(form) { await addToCart(form); await this.fetchCart() },
    async updateItem(id, data) { await updateCartItem(id, data); await this.fetchCart() },
    async removeItem(id) { await deleteCartItem(id); await this.fetchCart() },
    toggleSelect(id) {
