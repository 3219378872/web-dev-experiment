<template>
  <div>
    <h2>轮播图管理</h2>
    <el-button type="primary" style="margin: 16px 0" @click="dialogVisible = true"
      >新增轮播图</el-button
      ...
      ><el-table-column label="预览" width="150"
        ><template #default="{ row }"
          ><img
            ...
            alt="轮播图"
            style="width: 120px; height: 60px; object-fit: cover" /></template></el-table-column
...
function save() {
  banners.value.push({ ...form, id: Date.now() });
