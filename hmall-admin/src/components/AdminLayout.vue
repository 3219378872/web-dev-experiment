<template>
  <el-container style="height: 100vh">
    <el-aside width="220px" style="background: #304156">
      <div
        style="color: #fff; text-align: center; padding: 16px; font-size: 18px; font-weight: bold"
      >
        hmall 管理后台
      </div>
      <el-menu
        :default-active="route.path"
        :default-openeds="['items-group', 'system-group']"
        router
      ...
      >
        <el-menu-item index="/dashboard"
          ><el-icon><DataAnalysis /></el-icon>数据看板</el-menu-item
        >
        ...
        <el-sub-menu index="items-group">
          <template #title
            ><el-icon><Goods /></el-icon>商品管理</template
          >
        ...
        <el-menu-item index="/orders"
          ><el-icon><Tickets /></el-icon>订单管理</el-menu-item
        >
